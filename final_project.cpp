...
void carWheels()
{
    glColor3f(0.0f, 0.0f, 0.0f); // Wheels: Pure Black
    circle(0.0f, 0.0f, 0.08f);

    glColor3f(0.75f, 0.75f, 0.75f); // Rims: Silver
    ...
    glColor3f(0.6f, 0.6f, 0.6f); // Hub: Darker Silver
...
void car(float x, float y)
{
    ...
    glColor3f(0.9f, 0.9f, 0.9f); // Car Body: Glossy White
    glBegin(GL_POLYGON);
    ...
    glLineWidth(2);
    glBegin(GL_LINES);
    glColor3f(1.0f, 1.0f, 1.0f); // Glass line
    glVertex2f(-0.16f+x,  0.16f+y);
    glVertex2f(-0.04f+x,  0.28f+y);
    glEnd();
    ...
    ///window
    glBegin(GL_QUADS);
    glColor3f(0.2f, 0.2f, 0.2f); // Window: Charcoal Gray
    ...
    glBegin(GL_POLYGON);
    glColor3f(0.2f, 0.2f, 0.2f); // Second window
    ...
    glColor3f(0.8f, 0.8f, 0.8f); // Wheel highlight: Bright Silver
    glPushMatrix();
...
void boat() {
    ...
    // Second upper part - deep navy blue
    ...
    // Upper cabin windows - light yellow
    glColor3ub(255, 255, 153); // pale yellow
    glBegin(GL_POLYGON);
    glVertex2f(110, 140);
    glVertex2f(110, 180);
    glVertex2f(140, 180);
...
void mosque()
{
    ...
    /// golden highlight on right wall
    glBegin(GL_POLYGON);
    glColor4f(1.0f, 0.85f, 0.0f, 0.25f); // transparent golden overlay
    glVertex2f(getX(-98), getY(38));
    glVertex2f(getX(-72), getY(38 + 30 * 1.67));
    glVertex2f(getX(-72), getY(38 + 30 * 1.67 + 110));
    glVertex2f(getX(-98), getY(148));
    glEnd();
    ...
    /// golden trim line
    glBegin(GL_POLYGON);
    glColor3f(1.0f, 0.9f, 0.6f); // golden-white top trim
    glVertex2f(getX(-350), getY(150));
    glVertex2f(getX(-100), getY(150));
    glVertex2f(getX(-100), getY(152));
    glVertex2f(getX(-350), getY(152));
    glEnd();
    ...
    glLineWidth(2.0f);
    glBegin(GL_LINES);
    glVertex2f(getX(-350), getY(150)); glVertex2f(getX(-100), getY(150));
    glVertex2f(getX(-100), getY(150)); glVertex2f(getX(-70), getY(36+30*1.67+114));
    glVertex2f(getX(-70), getY(36+30*1.67+114)); glVertex2f(getX(-320), getY(36+30*1.67+114));
    glVertex2f(getX(-320), getY(36+30*1.67+114)); glVertex2f(getX(-350), getY(150));
    glVertex2f(getX(-100), getY(36)); glVertex2f(getX(-70), getY(36+30*1.67));
    glVertex2f(getX(-70), getY(36+30*1.67)); glVertex2f(getX(-70), getY(36+30*1.67+114));
    glVertex2f(getX(-70), getY(36+30*1.67+114)); glVertex2f(getX(-100), getY(150));
    glVertex2f(getX(-100), getY(150)); glVertex2f(getX(-100), getY(36));
    glEnd();
    ...
    glBegin(GL_POLYGON); glVertex2f(getX(-330), getY(38)); glVertex2f(getX(-330), getY(85)); glVertex2f(getX(-290), getY(85)); glVertex2f(getX(-290), getY(38)); glEnd();
    glBegin(GL_POLYGON); glVertex2f(getX(-250), getY(38)); glVertex2f(getX(-250), getY(85)); glVertex2f(getX(-210), getY(85)); glVertex2f(getX(-210), getY(38)); glEnd();
    glBegin(GL_POLYGON); glVertex2f(getX(-170), getY(38)); glVertex2f(getX(-170), getY(85)); glVertex2f(getX(-130), getY(85)); glVertex2f(getX(-130), getY(38)); glEnd();

    /// door border highlights
    glColor3f(1.0f, 1.0f, 1.0f);
    glLineWidth(1.5f);
    glBegin(GL_LINE_LOOP); glVertex2f(getX(-330), getY(38)); glVertex2f(getX(-330), getY(85)); glVertex2f(getX(-290), getY(85)); glVertex2f(getX(-290), getY(38)); glEnd();
    glBegin(GL_LINE_LOOP); glVertex2f(getX(-250), getY(38)); glVertex2f(getX(-250), getY(85)); glVertex2f(getX(-210), getY(85)); glVertex2f(getX(-210), getY(38)); glEnd();
    glBegin(GL_LINE_LOOP); glVertex2f(getX(-170), getY(38)); glVertex2f(getX(-170), getY(85)); glVertex2f(getX(-130), getY(85)); glVertex2f(getX(-130), getY(38)); glEnd();

    /// center line
    glBegin(GL_POLYGON);
    glColor3f(0.4f, 0.25f, 0.1f);
    glVertex2f(getX(-228), getY(38)); glVertex2f(getX(-228), getY(85)); glVertex2f(getX(-232), getY(85)); glVertex2f(getX(-232), getY(38));
    glEnd();

    /// dome function with white + golden
    auto drawDome = [](float tx, float ty, float r, float dr=1.0f, float dg=0.85f, float db=0.2f) {
        glPushMatrix();
        glEnable(GL_BLEND);
        glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);

        // shadow
        glTranslatef(tx, ty - 0.02f, 0.0);
        glColor4f(0.0f, 0.0f, 0.0f, 0.2f);
        glBegin(GL_POLYGON);
        for (int i = 0; i < 60; i++) {
            float pi = 3.1416;
            float A = (i * 2 * pi) / 50;
            float x = (r+0.01f) * cos(A);
            float y = (r+0.005f) * sin(A);
            glVertex2f(x, y);
        }
        glEnd();

        // dome
        glTranslatef(0.0, 0.02f, 0.0);
        glColor3f(dr, dg, db);
        glBegin(GL_POLYGON);
        for (int i = 0; i < 60; i++) {
            float pi = 3.1416;
    ...
    drawDome(-.305, 0.23, 0.03); // golden
    drawDome(-.305, 0.37, 0.03);
    drawDome(-.20,  0.37, 0.03);
    drawDome(-.40,  0.37, 0.03);
    drawDome(-.305, 0.45, 0.025);
    drawDome(-.305, 0.53, 0.023);
    drawDome(-.3065,0.62, 0.0205);

    /// minarets
    glColor3f(0.18f, 0.38f, 0.28f);
    glBegin(GL_POLYGON); glVertex2f(getX(-245), getY(155)); glVertex2f(getX(-245), getY(180)); glVertex2f(getX(-215), getY(180)); glVertex2f(getX(-215), getY(155)); glEnd();
    glBegin(GL_POLYGON); glVertex2f(getX(-243), getY(185)); glVertex2f(getX(-243), getY(215)); glVertex2f(getX(-218), getY(215)); glVertex2f(getX(-218), getY(185)); glEnd();
    glBegin(GL_POLYGON); glVertex2f(getX(-240), getY(215)); glVertex2f(getX(-240), getY(245)); glVertex2f(getX(-220), getY(245)); glVertex2f(getX(-220), getY(215)); glEnd();
    glBegin(GL_POLYGON); glVertex2f(getX(-238), getY(245)); glVertex2f(getX(-238), getY(275)); glVertex2f(getX(-223), getY(275)); glVertex2f(getX(-223), getY(245)); glEnd();
    glBegin(GL_POLYGON); glVertex2f(getX(-235), getY(275)); glVertex2f(getX(-235), getY(285)); glVertex2f(getX(-228), getY(285)); glVertex2f(getX(-228), getY(275)); glEnd();

    /// crescent moon
    glColor3f(1.0f, 0.84f, 0.0f);
    glBegin(GL_TRIANGLE_FAN);
    glVertex2f(getX(-231.5), getY(288));
    for (int i = 0; i <= 180; i++) {
        float theta = 3.1416 * float(i) / 180.0;
        float x = 3 * cos(theta);
        float y = 6 * sin(theta);
        glVertex2f(getX(-231.5) + x/100.0f, getY(288) + y/100.0f);
    }
    glEnd();

    /// glow around crescent
    glBegin(GL_POLYGON);
    glColor4f(1.0f, 0.85f, 0.0f, 0.3f);
    glVertex2f(getX(-231.5)-0.01f, getY(288)-0.01f);
    glVertex2f(getX(-231.5)+0.01f, getY(288)-0.01f);
    glVertex2f(getX(-231.5)+0.01f, getY(288)+0.01f);
    glVertex2f(getX(-231.5)-0.01f, getY(288)+0.01f);
    glEnd();
    ...
    /// decoration lines
    glColor3f(1.0f, 0.98f, 0.90f);
    glBegin(GL_POLYGON); glVertex2f(getX(-350), getY(105)); glVertex2f(getX(-350), getY(108)); glVertex2f(getX(-100), getY(108)); glVertex2f(getX(-100), getY(105)); glEnd();
    glBegin(GL_POLYGON); glVertex2f(getX(-350), getY(115)); glVertex2f(getX(-350), getY(119)); glVertex2f(getX(-100), getY(119)); glVertex2f(getX(-100), getY(115)); glEnd();
    glBegin(GL_POLYGON); glVertex2f(getX(-350), getY(125)); glVertex2f(getX(-350), getY(128)); glVertex2f(getX(-100), getY(128)); glVertex2f(getX(-100), getY(125)); glEnd();

    /// light vertical lines on front wall
    glColor3f(0.9f, 0.95f, 0.9f);
    glLineWidth(1.0f);
    glBegin(GL_LINES);
    for (int i = -340; i < -110; i += 20) {
        glVertex2f(getX(i), getY(36));
        glVertex2f(getX(i), getY(150));
    }
    glEnd();
    ...
    glVertex2f(getX(-90), getY(30));
    glColor3f(0.3f, 0.3f, 0.3f);
    glVertex2f(getX(-90), getY(36));
    glVertex2f(getX(-360), getY(36));
    glEnd();
}
...
void train2(float x, float y)
{
    ...
    // Window 1
    glBegin(GL_QUADS);
    glColor3f(0.9, 0.9, 1.0);  // Light window color
...
void boat2()
{
    // Bottom outline - deep navy
    glBegin(GL_POLYGON);
    glColor3ub(20, 30, 60); // Deep navy blue
    ...
    // Main boat body - ocean teal
    glBegin(GL_POLYGON);
    glColor3ub(72, 201, 176); // Cool teal
    glVertex2f(0.43f, -0.5f);
    glVertex2f(0.53f, -0.53f);
    glVertex2f(0.63f, -0.53f);
    glVertex2f(0.73f, -0.53f);
    ...
    // Outline lines - marine blue
    glLineWidth(3);
    glBegin(GL_LINES);
    glColor3ub(0, 51, 102); // Marine blue
    glVertex2f(0.88f, -0.5f);
    glVertex2f(0.78f, -0.48f);
    glVertex2f(0.78f, -0.48f);
    glVertex2f(0.73f, -0.48f);
    ...
    // Boat frame detail lines - steel gray
    glLineWidth(9);
    glBegin(GL_LINES);
    glColor3ub(100, 100, 100); // Metallic gray
    glVertex2f(0.53f, -0.48f);
    ...
    // Flag rope or thread - light cyan
    glLineWidth(3);
    glBegin(GL_LINES);
    glColor3ub(173, 216, 230); // Light cyan
